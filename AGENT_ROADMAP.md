...
| 005 | D3 agent switcher palette frame (+ async git metrics) — first L3 feature | `~/.claude/plans/roost/005-agent-palette.md` | In review | [#265](https://github.com/charliek/roost/pull/265) |
