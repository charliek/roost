...
| Tab title (OSC 0/1/2)| Yes        | Updated live as the shell sets it; locked once you rename via `Cmd-R` / `Alt-R` or `roost-cli-rs set-title` |
...
- [Notifications](../guides/notifications.md) — how `roost-cli-rs` and OSC sequences surface in the UI
