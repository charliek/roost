...
!!! info "Legacy section"
    This describes the Go + GTK4 binary that ships from `main`. The Rust core + native UI architecture is at [Reference → Architecture](../architecture.md); the durable design rationale is in [Vision](../../development/vision.md).
